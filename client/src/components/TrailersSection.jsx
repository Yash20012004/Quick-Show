...
const TrailersSection = () => {
  ...
  {dummyTrailers.map((trailer) => (
    <div
      key={trailer.image}
      className='relative transition duration-300 transform hover:-translate-y-1 hover:opacity-100 group-hover:opacity-50 hover:!opacity-100 cursor-pointer max-md:h-60 md:max-h-60'
